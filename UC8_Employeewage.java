...
public class UC8_Employeewage {
	...
	public UC8_Employeewage (String Company, int fullTimeHrs, int partTimeHrs, int WAGE_PER_HRS, int DAY_PER_MONTH, int MAX_HRS)
	{
	...
	public static void main (String []args) {
		...
		UC8_Employeewage Company1 =new UC8_Employeewage("Company1",8,4,20,20,100);
		...
		UC8_Employeewage Company2 = new UC8_Employeewage("Company2",12,6,25,26,150);
		Company2.Attendance();
